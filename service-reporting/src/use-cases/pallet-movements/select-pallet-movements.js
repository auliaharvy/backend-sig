    ...
    if (res) {
      ...
      for (let i = 0; i < items.length; i++) {
        ...
        data.push({
          ...
          departure_code: departure.code ? departure.code : null,
          destination: destination.name ? destination.name : null,
          destination_code: destination.code ? destination.code : null,
          transporter: transporter.name ? transporter.name : null,
          transporter_code: transporter.code ? transporter.code : null,
